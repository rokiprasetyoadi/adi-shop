...
Route::middleware(['admin'])->group(function(){
    ...
    Route::post('/oder/{order}/confirm', [OrderController::class, 'confirm_payment'])->name('confirm_payment');
});
...
Route::middleware(['auth'])->group(function(){
    ...
    Route::post('/oder/{order}/pay', [OrderController::class, 'submit_payment_receipt'])->name('submit_payment_receipt');
